...
bandit29@bandit:/tmp/contras$ ls
repo
bandit29@bandit:/tmp/contras$ cd repo/
bandit29@bandit:/tmp/contras/repo$ ls
README.md
bandit29@bandit:/tmp/contras/repo$ cat README.md
# Bandit Notes
...
bandit29@bandit:/tmp/contras/repo$ git log
...
bandit29@bandit:/tmp/contras/repo$ git checkout fca34ddb7d1ff1f78df36538252aea650b0b040d
...
bandit29@bandit:/tmp/contras/repo$ git checkout 4364630b3b27c92aff7b36de7bb6ed2d30b60f88
...
bandit29@bandit:/tmp/contras/repo$ git branch
* (HEAD detached at 4364630)
  master
bandit29@bandit:/tmp/contras/repo$ git checkout master
Switched to branch 'master'
Your branch is up to date with 'origin/master'.
bandit29@bandit:/tmp/contras/repo$ git branch -a
* master
  remotes/origin/HEAD -> origin/master
  remotes/origin/dev
  remotes/origin/master
  remotes/origin/sploits-dev
bandit29@bandit:/tmp/contras/repo$ git checkout dev
Branch 'dev' set up to track remote branch 'dev' from 'origin'.
Switched to a new branch 'dev'
bandit29@bandit:/tmp/contras/repo$ git status
On branch dev
...
## Referencias 
https://www.youtube.com/watch?v=Ae5ASDXkhSk