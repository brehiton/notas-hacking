...
## Solucion
```
┌──(hectorr㉿kali2024)-[~/picoCTF/Forensic/MacroHard WeakEdge]
...
┌──(hectorr㉿kali2024)-[~/picoCTF/Forensic/MacroHard WeakEdge]
└─$ echo "Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Q" | tr -d " " | base64
Wm14aFp6b2djR2xqYjBOVVJudEVNV1JmZFY5cmJqQjNYM0J3ZEhOZmNsOTZNWEExZlEK
...
```
## Notas adicionales 
lo que fue es que comprimimos el archivo que nos dio y luego hicimos la busquedad de la bandera encontramos un archivo que tenia letras en base64 le hicimos una decincriptacion y listo
## Referencias 